    ...
    <div id="lower">
        ...
        <div id="low-docs" class="">
            <div class="curved container">
                ...
                <ul>
                    <li><a href="https://tomcat.apache.org/bugreport.html">Tomcat @VERSION_MAJOR_MINOR@ Bug Database</a>
                    </li>
                    <li><a href="${tomcatDocUrl}api/index.html">Tomcat @VERSION_MAJOR_MINOR@ JavaDocs</a></li>
                    <li><a href="https://github.com/apache/tomcat/tree/@GIT_BRANCH@">Tomcat @VERSION_MAJOR_MINOR@ Git
                        Repository at GitHub</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="curved container">
                ...
                <ul>
                    <li id="list-announce"><strong><a
                            href="${tomcatUrl}lists.html#tomcat-announce">tomcat-announce</a><br/>
