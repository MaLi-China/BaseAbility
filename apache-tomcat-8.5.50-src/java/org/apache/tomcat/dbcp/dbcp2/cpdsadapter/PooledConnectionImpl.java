...
class PooledConnectionImpl
     ...
     *
     * @throws SQLException Thrown when an error occurs or the connection is already closed.
     */
    @Override
     ...
     *
     * @param key          ignored
     * @param pooledObject the wrapped {@link PreparedStatement} to be destroyed.
     */
    @Override
    ...
    public PooledObject<DelegatingPreparedStatement> makeObject(final PStmtKey key) throws Exception {
        ...
        @SuppressWarnings("unchecked") final PoolableCallableStatement pcs = new PoolableCallableStatement(statement, key, pStmtPool,
     ...
     *
     * @param key          ignored
     * @param pooledObject a wrapped {@link PreparedStatement}
     */
    @Override
     ...
     * @throws SQLException Thrown if a database access error occurs, this method is called on a closed connection or the given
